...
saveScoreEl.addEventListener("click", function () {
  ...
  var previousScoreHistory = JSON.parse(localStorage.getItem("codequiz")) || [];
  previousScoreHistory.push({
    user: initials,
    score: score,
  });
  localStorage.setItem("codequiz", JSON.stringify(previousScoreHistory));
});
